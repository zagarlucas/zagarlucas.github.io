    ...
    return (
        <section className="mb-16">
            ...
            <div className="relative space-y-12">
                {/* Vertical Line */}
                <div className="absolute top-2 left-3.5 bottom-2 w-0.5 bg-gradient-to-b from-cyan-500/30 via-zinc-800 to-transparent" />
                ...
                {data.experience.map((exp, index) => (
                    <div key={index} className="relative pl-10 group">
                        ...
                        <div className="text-cyan-400 font-semibold mb-3 text-lg leading-tight">
                            {exp.role}
                        </div>
