...
export const Footer = ({ data }: FooterProps) => {
    return (
        <footer className="mt-20 py-12 border-t border-zinc-800/50">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                <div>
                    <h3 className="text-xl font-bold text-zinc-100 mb-2">{data.name}</h3>
            ...
            <div className="mt-8 text-center text-zinc-600 text-xs uppercase tracking-widest">
                Optimizado para Recrutamiento y ATS • 2026
            </div>
        </footer>
    );
};
