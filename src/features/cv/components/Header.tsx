    ...
    return (
        <header className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-16 relative">
            ...
            <div className="text-center md:text-left flex-1 relative z-10">
                <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-b from-white via-green-400 to-transparent bg-clip-text text-transparent mb-2 tracking-tight">
                    {data.name}
                </h1>
                <p className="text-xl md:text-2xl text-zinc-100 font-medium mb-4">{data.title}</p>
                ...
                <div className="flex justify-center md:justify-start gap-3 mb-6">
                    {data.links.github && (
                        <a
                            ...
                            className="px-4 py-2 bg-zinc-800/50 hover:bg-zinc-800 rounded-lg text-sm font-semibold transition-colors border border-zinc-700 hover:border-cyan-500/50 flex items-center gap-2"
                        >
                ...
                {data.about && (
                    <p className="text-zinc-400 max-w-2xl leading-relaxed text-sm md:text-base border-l-2 border-zinc-700 pl-4">
                        {data.about}
                    </p>
                )}
            </div>
