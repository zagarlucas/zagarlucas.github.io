                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-8">
                    {data.phone && (
                        <a
                            ...
                            className="px-6 py-2.5 bg-cyan-600 hover:bg-cyan-500 text-white rounded-full text-sm font-bold transition-all shadow-lg shadow-cyan-900/20 hover:scale-105 flex items-center gap-2.5"
                        >
