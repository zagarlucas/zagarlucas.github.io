...
export const CV_DATA_V2: CVData = {
    name: "LUCAS ZAGAR",
    ...
    skills: [
        "JavaScript (ES6+)", "React / Next.js", "TypeScript", "Node.js",
        "HTML5 / CSS3 / SASS", "Tailwind CSS",
        "Odoo ERP Development", "Botmaker Automation",
        "SEO Tech & Analytics", "Git / GitHub"
    ],
    experience: [
        {
    ...
    links: {
        email: "lucaszagar1@hotmail.com",
        github: "https://github.com/zagarlucas", // Placeholder based on common pattern, user can update
        linkedin: "https://www.linkedin.com/in/lucas-zagar-03ba0a189/" // Placeholder
    },
    languages: [
        "Español: Nativo",
